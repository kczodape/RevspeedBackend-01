...
public interface ChannelRepository extends JpaRepository<ChannelCategory, Long> {
    @Query("SELECT new com.coderdot.dto.ChannelDTO(e.englishChannelName, cc.channelCategoryName, e.price) FROM English e " +
    ...
    @Query("SELECT new com.coderdot.dto.ChannelDTO(h.hindiChannelName, cc.channelCategoryName, h.price) FROM Hindi h " +
    ...
    @Query("SELECT new com.coderdot.dto.ChannelDTO(t.tamilChannelName, cc.channelCategoryName, t.price) FROM Tamil t " +
